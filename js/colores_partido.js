// js/colores_partido.js — Paleta política curada. No editar sin actualizar NORMALIZAR_PARTIDO.
...
const NORMALIZAR_PARTIDO = {
  ...
  'Sí Colombia':'Partido de la U',
  'SI COLOMBIA':'Partido de la U',
  'Si Colombia':'Partido de la U',
  // CAMBIO RADICAL
  ...
  // PACTO HISTÓRICO (incluye Colombia Humana — mismo proyecto político)
  ...
  'COLOMBIA HUMANA':'Pacto Histórico',
  'Colombia Humana – Unión Patriótica':'Pacto Histórico',
  'Colombia Humana – Unión Patriótica':'Pacto Histórico',
  // MOVIMIENTO MIRA
  ...
  // COALICIONES FAJARDO (Centro Esperanza + Coalición Colombia + Compromiso Ciudadano = mismo color)
  ...
  'COALICIÓN ALIANZA VERDE Y CENTRO ESPERANZA':'Centro Esperanza',
  'Compromiso Ciudadano por Colombia':'Centro Esperanza',
  'COMPROMISO CIUDADANO POR COLOMBIA':'Centro Esperanza',
  ...
  'FUERZA CIUDADANA LA FUERZA DEL CAMBIO':'Fuerza Ciudadana',
  // COLOMBIA PIENSA EN GRANDE
  'Colombia Piensa en Grande':'Colombia Piensa en Grande',
  'COLOMBIA PIENSA EN GRANDE':'Colombia Piensa en Grande',
  // PARTIDO PIN
  'Partido PIN':'Partido PIN',
  'PARTIDO DE INTEGRACION NACIONAL  PIN':'Partido PIN',
  'Partido De Integracion Nacional  Pin':'Partido PIN',
  // PLEBISCITO 2016
...
function colorPartido(nombre) {
  return COLORES_PARTIDO[normalizePartido(nombre)] || '#9CA3AF';
}
