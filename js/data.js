...
// ==================== COLORES DE PARTIDOS ====================
const palabrasClave = {
    'PARTIDO ALIANZA VERDE': ['VERDE', 'ALIANZA VERDE', 'ALIANZA POR COLOMBIA', 'BOYACÁ GRANDE', 'BOYACA GRANDE', 'GRAN ALIANZA POR BOYACA', 'HECHOS Y NO PALABRAS', 'ALIANZA PARA EL DESARROLLO', 'GENERACION DE OPORTUNIDADES', 'MARIPI, UN COMPROMISO DE CORAZON', 'UNIDOS MIRAFLORES PROGRESA MAS', 'UNIDOS POR NUESTRA TIERRA', 'EN PAIPA SOLO FALTA SUMERCE', 'CONSTRUYENDO EL PAYA QUE TODOS QUEREMOS', 'UNIDOS POR EL DESARROLLO DE PESCA', 'UNIDOS CONSTRUIMOS DESARROLLO SOCIAL', 'SEGUIMOS COMPROMETIDOS CON SAMACA', 'SEMBRANDO FUTURO POR SAN PABLO DE BORBUR', 'COALICION POR UN MEJOR MAÑANA', 'POR EL RENACER DE TOGUI, JUNTOS PODEMOS MAS', 'UNIDOS POR EL DESARROLLO DE BOAVITA', 'JUNTOS POR EL FUTURO DE BOYACA', 'TODOS POR BRICEÑO', 'PARTIDO VERDE Y PARTIDO DE LA U', 'CHIVATA, MANOS A LA OBRA', 'POR EL BIENESTAR, LA SALUD Y EL CAMPO', 'COALICIÓN GOBIERNO EN EQUIPO PARA SEGUIR PROGRESANDO', 'COMPROMISO POR GUATEQUE', 'ES CON HECHOS, NO CON PALABRAS', 'COMPROMISO Y GESTIÓN JENESANO NUESTRA MISIÓN', 'UNIDOS SOMOS MAS', 'UNIDOS SOMOS EL EQUIPO DEL CAMBIO', 'CONSTRUYENDO CON AMOR', 'JUNTOS SI PODEMOS', 'RAQUIRA DIGNA', 'TODOS MARCHANDO POR UN CAMBIO', 'PA SERVIRLE A SUMERCE', 'LIDERAZGO Y GESTION, GARANTIA DE BUEN GOBIERNO', 'TRABAJEMOS UNIDOS POR SORACA', 'TRABAJAMOS POR SUTATENZA', 'UNIDOS POR UN TIBANA DE OPORTUNIDADES', 'TOCA POR BUEN CAMINO', 'TEJIENDO DESARROLLO', 'CONSTRUYAMOS UNA NUEVA HISTORIA', 'JUNTOS POR UMBITA', 'HAY CAMPO PARA TODOS', 'CONSULTA DE LAS SOLUCIONES: SALUD, SEGURIDAD Y EDUCACIÓN', 'CLAUDIA NAYIBE LOPEZ HERNANDEZ', 'FIRAVITOBA NOS UNE', 'OICATA CRECE EN BUENAS MANOS', 'SABOYA CRECE CON EL CAMPO', 'GAMEZA UN PUEBLO QUE NOS UNE'],
    'PARTIDO LIBERAL COLOMBIANO': ['LIBERAL', 'LIBERAL COLOMBIANO', 'RESULTADOS POR BOYACÁ', 'RESULTADOS PARA BOYACA', 'PARA SERVIRLE A USTED', 'UNIDOS POR EL PROGRESO DE CALDAS', 'JENESANO UN PROPOSITO DE TODOS', 'CONSTRUYENDO PROGRESO PARA MOTAVITA', 'NOBSA UNIDA', 'UNA NUEVA ESPERANZA PARA UN MUNICIPIO PROSPERO', 'SABOYA SOMOS TODOS', 'PROPUESTAS CLARAS PARA EL CAMBIO', 'EXPERIENCIA Y CAMBIO PARA VOLVER AL PROGRESO', 'UNIDOS DE VERDAD', 'TOTA POR UN FUTURO PROACTIVO', 'ZETAQUIRA SIGUE ADELANTE', 'COALICION LIBERAL', 'CHITARAQUE AUTORIDAD Y COMPROMISO ¡CON USTED!', 'CUITIVA NUESTRO COMPROMISO', 'COALICIÓN CONSTRUYAMOS OPORTUNIDADES PARA TODOS', 'COALICION ES EL MOMENTO DE UNIRNOS POR MONIQUIRA', 'OICATA MERECE MAS', 'PAIPA NOS MUEVE', 'LA FUERZA DEL FUTURO', 'POR QUE SAMACÁ MERECE MAS', 'JUNTOS LABRANDO FUTURO POR SAN JOSE DE PARE', 'UN GOBIERNO PARA TODOS', 'COALICIÓN EL MOMENTO ES AHORA', 'COALICION CONSTRUYENDO FUTURO', 'TIPACOQUE CONSTRUYE PROGRESO', 'POR UN TOGUI PRODUCTIVO Y SOSTENIBLE', 'TUTA SIGUE ADELANTE', 'COALICION AMOR POR VILLA DE LEYVA', 'PAZ DE RIO AVANZA', 'POR AMOR A TIBANA', 'SABEMOS HACERLO BIEN POR SAN JOSE DE PARE'],
    'PARTIDO CONSERVADOR COLOMBIANO': ['CONSERVADOR', 'DE CORAZON POR CHIVOR', 'CON EL DESARROLLO GANAMOS TODOS', 'SAN PABLO DE BORBUR SIEMPRE CONTIGO', 'PCC - LIBERAL - SIACHOQUE', 'TODA UNA VIDA AL SERVICIO DE SU GENTE Y DE SUSACÓN', 'GESTION Y COMPROMISO SOCIAL, CON ALMA TOPAGUENSE', '+PARTICIPACIÓN + COMUNIDAD + HECHOS', 'COALICION LCC', 'TODOS UNIDOS POR NUEVO COLON', 'CUENTE CONMIGO'],
    // Casos puntuales confirmados por Santiago (spot-check sesión julio 2026) --
    // buckets propios en vez de sumarlos a CR-NUEVO LIBERALISMO (ese bucket
    // mezcla Creemos y Nuevo Liberalismo, dos partidos distintos).
    'Movimiento Ciudadano': ['GUAYATA SOMOS TODOS', 'SUTAMARCHAN SOMOS TODOS', 'PRESENTES POR UN FUTURO SEGURO'],
    'Nuevo Liberalismo': ['CÓMBITA RENACE'],
    'CENTRO DEMOCRÁTICO': ['CENTRO DEMOCRÁTICO', 'CENTRO DEMOCRATICO', 'PARTIDO CENTRO DEMOCRATICO', 'JUNTOS ES EL MOMENTO', 'JUNTOS #ESMOMENTO', 'UNIDOS POR GUICAN', 'UNIDOS POR SAN JOSE PARE', 'UNIDOS SOMOS MAS', 'UNIDOS POR SIACHOQUE', 'SOATA JUNTOS POR UN MEJOR FUTURO', 'TRASFORMACION SOCIAL OPORTUNIDAD PARA TODOS', 'TENZA UNIDA PROGRESO DE TODOS', 'NUESTRO PROYECTO ES IZA', 'UNIDOS POR SATIVASUR', 'LA GRAN CONSULTA POR COLOMBIA', 'PALOMA SUSANA VALENCIA LASERNA', 'CON EL ALMA POR CHITARAQUE', 'SUMATE POR IZA COMPROMISO DE TODOS', 'LA UVITA SE PROYECTA'],
    'PARTIDO DE LA U': ['DE LA U', 'PARTIDO DE LA U', 'PARTIDO DE LA UNIÓN POR LA GENTE', 'EN EQUIPO HACEMOS MAS', 'SANABRIA ES MAS GESTION', 'UNIDOS POR UN MEJOR FUTURO PARA PAEZ', 'FRENTE POR LA VIDA', 'ROY LEONARDO BARRERAS MONTEALEGRE', 'TIPACOQUE AVANZA', 'ALCALDIA DE PAEZ', 'ALCALDIA DE RONDON', 'ALIANZA POR MIRAFLORES', 'COALICION POLITICA Y PROGRAMATICA'],
    ...
    'PARTIDO CAMBIO RADICAL': ['CAMBIO RADICAL', 'COALICIÓN CAMBIO RADICAL - ALMA', 'GOBIERNO DE RESULTADOS', 'SI ES POSIBLE', 'PARA SERVIRLE SUMERCE', 'AL SERVICIO DE LA GENTE', 'PUERTO BOYACA PRIMERO', 'FIRMEZA LEALTAD Y COMPROMISO', 'EL PROGRESO DE SUTAMARCHAN DEBE CONTINUAR', 'TUTA COMPROMISO DE TODOS', 'POR LA DIGNIDAD DE ARCABUCO', 'SOMOS ESPERANZA', 'YO SOY MARIPENSE', 'NOBSA A OTRO NIVEL', 'QUIPAMA LA FUERZA QUE NOS UNE', 'SOMOS MAS', 'GUATEQUE RAZONES PARA CONFIAR'],
    ...
    'MOVIMIENTO ALTERNATIVO INDIGENA Y SOCIAL MAIS': ['MAIS', 'GARAGOA SOMOS TODOS', 'DE CORAZÓN POR VENTAQUEMADA'],
    ...
    'ASI': ['ASI', 'PARTIDO ALIANZA SOCIAL INDEPENDIENTE', 'COALICION ALCALDIA DE COPER', 'UINDOS POR UNA VICTORIA PROSPERA Y SOLIDARIA', 'UNIDOS POR PESCA', 'POR EL RENACER DE UN PUEBLO UNIDO', 'UNIDOS POR TINJACA', 'UNIDOS POR OICATA'],
