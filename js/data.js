...
const palabrasClave = {
    ...
    'PARTIDO CONSERVADOR COLOMBIANO': ['CONSERVADOR', 'DE CORAZON POR CHIVOR', 'CON EL DESARROLLO GANAMOS TODOS', 'SAN PABLO DE BORBUR SIEMPRE CONTIGO', 'PCC - LIBERAL - SIACHOQUE', 'TODA UNA VIDA AL SERVICIO DE SU GENTE Y DE SUSACÓN', 'GESTION Y COMPROMISO SOCIAL, CON ALMA TOPAGUENSE', '+PARTICIPACIÓN + COMUNIDAD + HECHOS', 'COALICION LCC'],
    ...
    'Movimiento Ciudadano': ['GUAYATA SOMOS TODOS', 'SUTAMARCHAN SOMOS TODOS'],
    'Nuevo Liberalismo': ['CÓMBITA RENACE'],
    'CENTRO DEMOCRÁTICO': ['CENTRO DEMOCRÁTICO', 'CENTRO DEMOCRATICO', 'PARTIDO CENTRO DEMOCRATICO', 'JUNTOS ES EL MOMENTO', 'JUNTOS #ESMOMENTO', 'UNIDOS POR GUICAN', 'UNIDOS POR SAN JOSE PARE', 'UNIDOS SOMOS MAS', 'UNIDOS POR SIACHOQUE', 'SOATA JUNTOS POR UN MEJOR FUTURO', 'TRASFORMACION SOCIAL OPORTUNIDAD PARA TODOS', 'TENZA UNIDA PROGRESO DE TODOS', 'NUESTRO PROYECTO ES IZA', 'UNIDOS POR SATIVASUR', 'LA GRAN CONSULTA POR COLOMBIA', 'PALOMA SUSANA VALENCIA LASERNA', 'CON EL ALMA POR CHITARAQUE', 'SUMATE POR IZA COMPROMISO DE TODOS'],
    'PARTIDO DE LA U': ['DE LA U', 'PARTIDO DE LA U', 'PARTIDO DE LA UNIÓN POR LA GENTE', 'EN EQUIPO HACEMOS MAS', 'SANABRIA ES MAS GESTION', 'UNIDOS POR UN MEJOR FUTURO PARA PAEZ', 'FRENTE POR LA VIDA', 'ROY LEONARDO BARRERAS MONTEALEGRE', 'TIPACOQUE AVANZA', 'ALCALDIA DE PAEZ', 'ALCALDIA DE RONDON', 'ALIANZA POR MIRAFLORES'],
    ...
    'ASI': ['ASI', 'PARTIDO ALIANZA SOCIAL INDEPENDIENTE', 'COALICION ALCALDIA DE COPER', 'UINDOS POR UNA VICTORIA PROSPERA Y SOLIDARIA', 'UNIDOS POR PESCA', 'POR EL RENACER DE UN PUEBLO UNIDO', 'UNIDOS POR TINJACA'],
